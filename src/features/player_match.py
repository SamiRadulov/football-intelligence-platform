...
def compute_player_match(events: pd.DataFrame) -> pd.DataFrame:
    ...
    start_dist = _dist_to_goal(e["location_x"], e["location_y"])
    pass_end_dist = _dist_to_goal(e["pass_end_x"], e["pass_end_y"])
    carry_end_dist = _dist_to_goal(e["carry_end_x"], e["carry_end_y"])
    ...
    pass_box = open_play_completed & ~_in_box(e["location_x"], e["location_y"]) & _in_box(e["pass_end_x"], e["pass_end_y"])
    carry_box = is_carry & ~_in_box(e["location_x"], e["location_y"]) & _in_box(e["carry_end_x"], e["carry_end_y"])
    e["box_entries"] = (pass_box | carry_box).astype(int)

    # --- Creation ---
    e["key_passes"] = (is_pass & e["pass_shot_assist"]).astype(int)
    e["crosses_box"] = (completed & e["pass_cross"] & _in_box(e["pass_end_x"], e["pass_end_y"])).astype(int)
    ...
    e["box_shots"] = (np_shot & _in_box(e["location_x"], e["location_y"])).astype(int)
